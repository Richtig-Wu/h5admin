...
gyp WARN download NVM_NODEJS_ORG_MIRROR is deprecated and will be removed in node-gyp v4, please use NODEJS_ORG_MIRROR
gyp http GET https://nodejs.org/dist/v6.11.2/node-v6.11.2-headers.tar.gz
gyp http 200 https://nodejs.org/dist/v6.11.2/node-v6.11.2-headers.tar.gz
gyp http GET https://nodejs.org/dist/v6.11.2/SHASUMS256.txt
gyp http 200 https://nodejs.org/dist/v6.11.2/SHASUMS256.txt
...
gyp info spawn args   '/home/linux/node/socket/node_modules/uws/build/config.gypi',
gyp info spawn args   '-I',
...
gyp info spawn args   '-Dmodule_root_dir=/home/linux/node/socket/node_modules/uws',
